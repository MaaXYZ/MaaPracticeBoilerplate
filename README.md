...
本仓库为 [MaaFramework](https://github.com/MaaXYZ/MaaFramework) 所提供的项目模板，开发者可基于此模板直接创建自己的 MaaXXX 项目。目前正在施工，作为我的第一个练习项目，使用 [MFAWPF](https://github.com/SweetSmellFox/MFAWPF) 作为GUI。
...
## TODO：
因为是 Python 新手练习项目，使用较为简单的公主连结游戏作为目标游戏。
